...
object EventMessageAndControllerInitialize {
  implicit val decoder: Decoder[EventMessageAndControllerInitialize] = new Decoder[EventMessageAndControllerInitialize] {
    def decode(data: ByteString): EventMessageAndControllerInitialize = data(0).bits0To1.toUnsignedInt match {
...
case class McDeviceLocatorRecordKeyAndBody(
                                            ...
                                            deviceIdString: DeviceIdString) extends FruSdrKeyAndBody {
...
object McDeviceLocatorRecordKeyAndBody {
  ...
  implicit val decoder: Decoder[McDeviceLocatorRecordKeyAndBody] = new Decoder[McDeviceLocatorRecordKeyAndBody] {
    def decode(data: ByteString): McDeviceLocatorRecordKeyAndBody = {
      ...
      val acpiSystemPowerStateNotificationRequired = powerStateNotificationGlobalInitialization.bit7
      val acpiDevicePowerStateNotificationRequired = powerStateNotificationGlobalInitialization.bit6
      ...
      val eventMessage = powerStateNotificationGlobalInitialization.as[EventMessageAndControllerInitialize]
