...
sealed trait FruFieldType {
  def decode(data: ByteString, treatAsEnglish: Boolean)(implicit languageCode: LanguageCode): FruField
}
...
object FruFieldType {
  ...
  case object StandardString extends FruFieldType {
    def decode(data: ByteString, treatAsEnglish: Boolean)(implicit languageCode: LanguageCode): StringField =
