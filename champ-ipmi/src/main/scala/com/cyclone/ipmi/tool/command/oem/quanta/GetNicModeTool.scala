package com.cyclone.ipmi.tool.command.oem.quanta

import com.cyclone.command.TimeoutContext
import com.cyclone.ipmi.IpmiError
import com.cyclone.ipmi.command.oem.LanSource
import com.cyclone.ipmi.command.oem.quanta.GetLanSource
...
/**
  * [[IpmiToolCommand]] that wraps the Quanta [[GetLanSource]] low-level command.
  */
object GetNicModeTool {
  ...
  object Command extends IpmiToolCommand {
    ...
    def description() = "quanta get nic-mode"
  }
